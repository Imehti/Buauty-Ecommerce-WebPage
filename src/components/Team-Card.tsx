...
const TeamMembersCard = ({
  ...
  return (
    <>
      ...
      <div className="relative m-12 h-fit flex flex-col justify-center bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-300 dark:border-gray-300 dark:hover:bg-gray-300">
